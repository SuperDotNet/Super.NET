...
namespace Super.Diagnostics
{
	public sealed class Log<T> : Ambient<ILogger>, ILog
	{
		...
		ILogger ILogger.ForContext(string propertyName, object value, bool destructureObjects) => Get().ForContext(propertyName, value, destructureObjects);
		...
		void ILogger.Write<T0, T1, T2>(LogEventLevel level, System.Exception exception, string messageTemplate, T0 propertyValue0,
		                               T1 propertyValue1, T2 propertyValue2)
		{
			Get().Write(level, exception, messageTemplate, propertyValue0, propertyValue1, propertyValue2);
		}

		void ILogger.Write(LogEventLevel level, System.Exception exception, string messageTemplate, params object[] propertyValues)
		{
		...
		void ILogger.Verbose<T0, T1, T2>(System.Exception exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1,
		                                 T2 propertyValue2)
		{
		...
		void ILogger.Debug<T0, T1, T2>(System.Exception exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1,
		                               T2 propertyValue2)
		{
		...
		void ILogger.Information<T0, T1>(System.Exception exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1)
		{
			Get().Information(exception, messageTemplate, propertyValue0, propertyValue1);
		}

		void ILogger.Information<T0, T1, T2>(System.Exception exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1,
		                                     T2 propertyValue2)
		{
		...
		void ILogger.Warning<T0, T1, T2>(System.Exception exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1,
		                                 T2 propertyValue2)
		{
		...
		void ILogger.Error<T0, T1, T2>(System.Exception exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1,
		                               T2 propertyValue2)
		{
		...
		void ILogger.Fatal<T0, T1, T2>(System.Exception exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1,
		                               T2 propertyValue2)
		{
		...
		bool ILogger.BindMessageTemplate(string messageTemplate, object[] propertyValues, out MessageTemplate parsedTemplate,
		                                 out IEnumerable<LogEventProperty> boundProperties) => Get().BindMessageTemplate(messageTemplate, propertyValues, out parsedTemplate, out boundProperties);
