...
{
	public sealed class LoggingContext : DelegatedDisposable, IApplicationLogger
	{
		readonly ILogger _logger;

		public LoggingContext(ILogger logger) : this(logger, logger.To<IDisposable>()) {}

		public LoggingContext(ILogger logger, IDisposable disposable) : base(disposable.Dispose) => _logger = logger;
