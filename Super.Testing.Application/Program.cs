...
namespace Super.Testing.Application
{
	public class Program
	{
		static void Main()
		{
			...
			var native = new Native.LargeArrayBuilder<int>(true);
	...
	public class Benchmarks
	{
		...
		public Benchmarks() : this(Objects.NativeArray.Default, Objects.Chain.Default, Objects.Combo.Default,
								   Objects.ExpressionCombo.Default, Objects.Expression.Default) {}

		public Benchmarks(IArray<int> native, IArray<int> chain, IArray<int> combo, IArray<int> expressionCombo, IArray<int> expression)
		{
			_native = native;
			_chain = chain;
			_combo = combo;
